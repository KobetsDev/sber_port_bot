...
true_mass = ['Расписание лекций',
            'Задание TechQuest', 
            '📍Добавить мероприятие',
             '👥Все пользователи', 'Расписание лекций', '📥Моё участие📥',
             'Анкета участника', '📑Распоряжения']
register_command = ['Нужна помощь', 'Регистрация']
admin_command = ['📍Добавить мероприятие',
                 '👥Все пользователи', 
                 'Отправить соощение всем пользователям',
                 ]
